...
SIGN_UP_REQUEST_PARAMS = {'db', 'login', 'debug', 'token', 'message', 'error', 'scope', 'mode',
                          ...
                          'password', 'confirm_password', 'city', 'country_id', 'lang', 'title', 'name', 'instansi', 'phone','pekerjaan', 'notifikasi', 'type_pendaftaran', 'nik', 'pekerjaan_lainnya', 'referensi', 'referensi_lainnya', 'alamat', 'title_field'}
...
class Home(http.Controller):
    ...
    def web_login(self, redirect=None, **kw):
        ...
        # response = request.render('web.login', values) # update by henro
